...
router.get('/Admin/AddUsersCourses/', auth.requireLogin, async (req, res) => {
  let context = {};
...
router.get('/Admin/DropUsersCourses/', auth.requireLogin, async (req, res) => {
  let context = {};
...
router.get('/Admin/AddDropCoursesCategories/', auth.requireLogin, async (req, res) => {
  let context = {};
...
router.get('/Admin/AddDropLanguagesCourses/', auth.requireLogin, async (req, res) => {
  let context = {};
...
router.get('/Admin/AddDropLanguagesModules/', auth.requireLogin, async (req, res) => {
  let context = {};
